...
def main():
    ...
    if True:
        ...
        def maxErrorFromFeeJoblib(fee): 
            ...
            simulations with different price actions given these parameters
            '''
            results = Parallel(n_jobs=-1, verbose=1, backend='multiprocessing')(delayed(returnErrors)(fee, initial_tau, time_steps_size, time_horizon, volatility, drift, strike, strike*0.8) for i in range(2))
